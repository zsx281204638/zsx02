...
public class QiNiuUtils {
    ...
    private static final String ACCESSKEY = "WKmKT3alLd_4PKTxGk7oRbB9xb9IswaXZC9y5kxK";
    private static final String SECRETKEY = "eJtNZ0UphlWAQgXdobuvUAogCmIGT3sPQNvVp_fk";
    // 对象仓库
    private static final String BUCKET = "zsx01";
    public static final String DOMAIN= "http://qtpha4t8v.hn-bkt.clouddn.com/";
